 <footer class="ps-footer">
     <div id="partner-ads" style="margin-bottom:6rem;border-bottom: 1px solid #e1e1e1;" class="ps-container">
         ...
         <div class="multiple-items">
             <a class="" href="#"><img src="{{ env('APP_URL') }}/storage/products/12-300x300.jpg"
                     alt=""></a>
         ...
         <div class="ps-popup__content bg--cover"
             ...
             <form method="post" action="{{ route('public.newsletter.subscribe') }}"
                 ...
                 <div class="ps-form__content">
                     ...
                     <p>{{ __('Subscribe to the mailing list to receive updates on new arrivals, special offers and our promotions.') }}
                     </p>
